...
export default class RepeatSign extends Component {
  render() {
    ...
    if(repeatEnd) {
      return (
        <g>
          <rect x={measureWidth - 7} y={y} height={height} width={0.8} strokeWidth={0.1} fill='#2d2d2d'></rect>
          <rect x={measureWidth - 3} y={y} height={height} width={3} strokeWidth={0.1} fill='#2d2d2d'></rect>
    ...
    return (
      <g>
        <rect x={5.5} y={y} height={height} width={0.8} strokeWidth={0.1} fill='#2d2d2d'></rect>
        <rect x={0} y={y} height={height} width={3} strokeWidth={0.1} fill='#2d2d2d'></rect>
