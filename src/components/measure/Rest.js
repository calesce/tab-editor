...
export default class Rest extends Component {
  ...
  renderQuarterRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='20.53' height='26.7' x={this.props.x} y={45}>
        <path
  ...
  renderEighthRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='20.03' height='17.67' x={this.props.x} y={45}>
  ...
  renderSixteenthRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='20.66' height='26.65' x={this.props.x} y={45}>
  ...
  renderHalfRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='30' height='62' x={this.props.x - 9} y={40}>
        <g>
  ...
  renderWholeRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='30' height='62' x={this.props.x - 9} y={32.5}>
