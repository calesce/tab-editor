...
export default class Rest extends Component {
  ...
  renderEighthRest = () => {
    return (
      <svg width='10.03' height='17.67' x={this.props.x} y={30}>
  ...
  renderSixteenthRest = () => {
    return (
      <svg width='12.66' height='26.65' x={this.props.x} y={30}>
  ...
  render() {
    switch(this.props.duration) {
      case 'q':
        return this.renderQuarterRest();
      case 'e':
        return this.renderEighthRest();
      case 's':
        return this.renderSixteenthRest();
      case 'h':
        return this.renderHalfRest();
      case 'w':
        return this.renderWholeRest();
      default:
        return this.renderQuarterRest();
    }
  }
