...
export default class Rest extends Component {
  ...
  renderQuarterRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='10.53' height='26.7' x={this.props.x} y={30}>
        <path
  ...
  renderEighthRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='10.03' height='17.67' x={this.props.x} y={30}>
  ...
  renderSixteenthRest = (style) => {
    return (
      <svg onClick={this.restClicked} style={style} width='12.66' height='26.65' x={this.props.x} y={30}>
