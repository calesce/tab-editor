...
export const RepeatEnd = connect(
  ...
  return (
    <svg onClick={onClick} width='40' height='50' className={css(selected ? styles.selected : styles.hover)}>
      <rect x={17.5} y={3} height={38} width={0.8} strokeWidth={0.1}></rect>
      <rect x={21} y={3} height={38} width={3} strokeWidth={0.1}></rect>
...
export const RepeatBegin = connect(
  ...
  return (
    <svg onClick={onClick} width='40' height='50' className={css(selected ? styles.selected : styles.hover)}>
      <rect x={14} y={3} height={38} width={3} strokeWidth={0.1}></rect>
      <rect x={19.5} y={3} height={38} width={0.8} strokeWidth={0.1}></rect>
