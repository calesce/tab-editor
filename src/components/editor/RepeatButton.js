...
const isSelected = repeatEnd => state => {
  ...
  return { cursor: state.cursor, selected: repeatEnd ? measure.repeatEnd : measure.repeatBegin };
};

export const RepeatEnd = connect(isSelected(true), { toggleRepeatEnd })((
...
export const RepeatBegin = connect(isSelected(false), { toggleRepeatBegin })((
