...
export const MetronomeButton = connect(isMetronomeSelected, { toggleMetronome })((
    ...
    return (
      ...
      >
        <g transform="translate(3.5, 8), scale(0.2)">
          <polygon fill="none" strokeWidth="6" points="4 178 154 178 104 3 54 3" />
...
export const CountdownButton = connect(isCountdownSelected, { toggleCountdown })((
