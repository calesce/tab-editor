...
const WholeNote = () => {
  return (
    <g transform='scale(0.8), translate(15, 8)'>
      <path strokeOpacity='0.2' stroke='grey'
...
const QuarterNote = () => {
  return (
    <g transform='scale(0.8), translate(15, 10)'>
      <path strokeWidth={0} d='M11.980408 34.601027c3.667507-1.965567 5.621702-5.523714 4.419597-8.200397-1.28224-2.85513-5.68837-3.660897-9.835104-1.7986-4.146725 1.862308-6.471533 5.690953-5.18929 8.546072 1.28225 2.85513 5.68837 3.660898 9.835103 1.7986.25917-.116393.525184-.21464.769696-1.425677z'/>
  ...
  return (
    <g transform='scale(0.8), translate(15, 10)'>
      <g transform='matrix(.125 0 0 .125 -4 -12.5)'>
        ...
        <path d='M149.5 6v323.05V6zM213.92406 101.04561c-28.59228-38.14294-59.86623-45.92692-59.86623-45.92692V7.6224c0 .91303-4.33153 7.27183 12.56624 26.3776 2.52347 2.8532 10.00702 9.9108 51.7437 45.57988 6.67432 5.70403 51.64764 73.4412 27.23124 114.88894l-6.03174-8.987c5.255-10.278 2.94907-46.29325-25.6432-84.4362z'></path>
        <path d='M221.992 194.508c-23.1-27.952-68.09-39.207-68.09-39.207V77.51c0-5.047-.226 25.933 9.935 34.676 29.577 25.452 38.977 36.87 58.155 52.676 53.52 44.11 20.69 123.34 17.62 146.345H228.1c2.64-8.537 22.23-82.41-6.106-116.7z'></path>
      </g>
    </g>
  );
};
...
const TremoloButton = () => (
  <g transform='scale(1.0), translate(8, 13)'>
    <path strokeWidth={0} d='M17.025 0L4.538 6.412V3.375l12.487-6.412m0 8.55L4.538 11.925V8.887l12.487-6.412m0 8.55L4.538 17.437V14.4l12.487-6.413'/>
  </g>
);
  ...
  render() {
    ...
    return (
      <svg onMouseEnter={this.onMouseEnter} onMouseLeave={this.onMouseLeave} onClick={this.onClick}
        width={40} height={50} className={css(styles.button, selected && styles.selected)}>
        {icon}
      </svg>
    );
  }
