...
class ImportButton extends Component {
  ...
  render() {
    return (
      <div>
        <svg onClick={this.importClicked} width={40} height={50} className={css(styles.hover)}>
        ...
        <input ref={this.inputRef} type='file' className={css(styles.hidden)} onChange={this.onImport} />
      </div>
    );
  }
}
