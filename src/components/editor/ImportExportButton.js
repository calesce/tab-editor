...
class ImportButton extends Component {
  ...
  render() {
    return (
      <div>
        <svg onClick={this.importClicked} width={40} height={50} style={this.props.style}>
...
export default connect(null, { replaceSong })(hover()(ImportButton));

export const ExportButton =
  connect(getTracksSelector)(
    hover()(({ style, color, tracks }) => {
