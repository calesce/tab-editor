...
export const UndoButton =
  connect(canUndo, { undo })(
    (({ canUndo, undo }) => (
      <svg onClick={undo} width={40} height={50} className={css(canUndo ? styles.hover : styles.disabled)}>
...
export const RedoButton =
  connect(canRedo, { redo })(
    (({ canRedo, redo }) => (
      <svg onClick={redo} width={40} height={50} className={css(canRedo ? styles.hover : styles.disabled)}>
